  ...
  var PhysicsOutput = (function () {
    ...
    PhysicsOutput.prototype.evaluateValue = function (translation, particles) {
      ...
      if (this.factor.angle > 0) {
        ...
        value +=
          (translation.x - parentGravity.x > 0 ? -angleResult : angleResult) * this.factor.angle
      }
      value *= this.invert ? -1 : 1
      return value
    }
  ...
  var PhysicsSubRig = (function () {
    ...
    PhysicsSubRig.prototype._evaluate = function (target) {
      ...
      this.output.forEach(function (o) {
        ...
        var translation = _this.particles[o.particleIndex - 1].position.substract(
          _this.particles[o.particleIndex].position
        )
        ...
        var unclampedParameterValue =
          parameters.values[parameterIndex] * (1 - o.normalizedWeight) + value * o.normalizedWeight
