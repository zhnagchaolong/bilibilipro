  ...
  var Model = (function (_super) {
    ...
    function Model(coreModel, textures, animator, physicsRig, userData, groups) {
      ...
      for (var m = 0; m < _this._meshes.length; ++m) {
        ...
        _this._meshes[m].isCulling = !Live2DCubismCore.Utils.hasIsDoubleSidedBit(
          _this._coreModel.drawables.constantFlags[m]
        )
        if (
          Live2DCubismCore.Utils.hasBlendAdditiveBit(_this._coreModel.drawables.constantFlags[m])
        ) {
