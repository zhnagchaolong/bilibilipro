    ...
    return function (_em_module) {
      ...
      var asm = (function (global, env, buffer) {
            ...
            do {
              if (w & (q & (!(k < 0) & !(z < 0)))) {
                ...
                if (!L) {
                  ...
                  n[(c + (K << 3)) >> 2] =
                    z * (h * +n[(Z + (w << 3)) >> 2]) +
                    (z * (o * k) + (B * (h * l) + B * (o * +n[(Z + (q << 3)) >> 2])))
                  B =
                    z * (h * +n[(Z + (w << 3) + 4) >> 2]) +
                    (z * (o * i) + (B * (h * j) + B * (o * +n[(Z + (q << 3) + 4) >> 2])))
                  l = G
                  m = H
                  k = I
                  i = J
        ...
        function vb(a) {
          ...
          while (1) {
            if (
              f[d >> 2] | 0 ? ((e = f[c >> 2] | 0), (g = f[(a + 12) >> 2] << 1), (g | 0) > 1) : 0
            ) {
              b = 1
              do {
                i = (e + (b << 2)) | 0
        ...
        function wb(a) {
          ...
          if ((ua | 0) > 0) {
            ...
            while (1) {
              if (
                f[e >> 2] | 0
                  ? ((oa = +n[d >> 2]), (n[g >> 2] = oa), (ra = f[c >> 2] | 0), (ra | 0) != -1)
                  : 0
              )
                n[g >> 2] = oa * +n[(o + (ra << 2)) >> 2]
              c = (c + 8) | 0
          ...
          if (f[na >> 2] | 0) {
            ...
            while (1) {
              if (
                (f[(d + (c << 2)) >> 2] | 0) != 0 ? +n[((f[e >> 2] | 0) + (c << 2)) >> 2] != 0 : 0
              )
                d = 63
              else d = 62
              b[((f[g >> 2] | 0) + c) >> 0] = d
        ...
        function Db(a) {
          ...
          if (
            a | 0
              ? ((l = f[1464] | 0), (n = (l + k) | 0), (n >>> 0 <= l >>> 0) | (n >>> 0 > a >>> 0))
              : 0
          ) {
            w = 0
            t = x
          ...
          if ((q | 0) == 145) {
            ...
            f: do {
              if (j) {
                ...
                if (
                  ((q | 0) == 154 ? ((v = (b + 4) | 0), ((f[(b + 12) >> 2] & 8) | 0) == 0) : 0)
                    ? (g >>> 0 > j >>> 0) & (a >>> 0 <= j >>> 0)
                    : 0
                ) {
                  f[v >> 2] = c + h
      ...
      var _csmGetDrawableConstantFlags = (Module['_csmGetDrawableConstantFlags'] =
      ...
      var _csmGetDrawableTextureIndices = (Module['_csmGetDrawableTextureIndices'] =
      ...
      var _csmGetDrawableVertexPositions = (Module['_csmGetDrawableVertexPositions'] =
      ...
      var _csmGetParameterDefaultValues = (Module['_csmGetParameterDefaultValues'] =
        asm['_csmGetParameterDefaultValues'])
      var _csmGetParameterIds = (Module['_csmGetParameterIds'] = asm['_csmGetParameterIds'])
      var _csmGetParameterMaximumValues = (Module['_csmGetParameterMaximumValues'] =
        asm['_csmGetParameterMaximumValues'])
      var _csmGetParameterMinimumValues = (Module['_csmGetParameterMinimumValues'] =
      ...
      var _csmGetPartParentPartIndices = (Module['_csmGetPartParentPartIndices'] =
      ...
      var _csmMallocModelAndInitialize = (Module['_csmMallocModelAndInitialize'] =
        asm['_csmMallocModelAndInitialize'])
      var _csmReadCanvasInfo = (Module['_csmReadCanvasInfo'] = asm['_csmReadCanvasInfo'])
      var _csmResetDrawableDynamicFlags = (Module['_csmResetDrawableDynamicFlags'] =
